...
router.get('/join', clubhouseController.clubhouse_locals ,clubhouseController.clubhouse_passcode_get);

router.post('/join', clubhouseController.clubhouse_passcode_post);

router.get('/form', clubhouseController.clubhouse_locals ,clubhouseController.clubhouse_form_get);
